...
export const fakeBanner = [
  'https://tinyyume.com/cdn/shop/files/Snapinsta.app_338458269_879996006396274_990222832187670111_n_1080_360x.jpg?v=1680243210',
...
export const fakeVoucher = {
  ...
  amount: '10',
  description:
    'Lượt sử dụng có hạn. Nhanh tay kẻo lỡ bạn nhé!Giảm 8% Đơn Tối Thiểu ₫99k Giảm tối đa ₫100k.',
  productApplied:
  ...
  detail:
    'Mã HC0108 giảm 8% tối đa 100000Đ cho đơn từ 99000Đ. HSD: 23:59 1/8/2024. Số lượng có hạn.',
}
      ...
      subsection: [
        {
          title: '',
          content:
            '&lWebsite thương mại điện tử của <b>Langfarm</b> hiện đang chấp nhận 3 hình thức thanh toán như sau:Thanh toán tiền mặt khi nhận hàng (Thanh toán COD):Chuyển khoản qua ngân hàng:Thanh toán online (Cổng thanh toán VNPAY)',
          image: [],
        },
        {
          title: 'Lưu ý',
          content:
            'Hình thức thanh toán COD chỉ áp dụng cho đơn hàng có giá trị từ <b>2,000,000đ</b> trở xuống',
          image: [],
        },
        {
...
export const fakeBlogReturnPolicy = {
  ...
  viewed: 10,
  image:
    'https://codedeco.art/wp-content/uploads/2021/07/Minimalist-January-Month-Fashion-Sale-Banner-Email-Header-10.5-%C3%97-5-cm-4-1024x488.jpg',
  content: [
    {
      section: '',
      subsection: [
  ...
  type: 'cs',
  description:
    'Với phương châm đặt lợi ích của khách hàng lên hàng đầu, Langfarm chấp nhận đổi trả toàn bộ sản phẩm hư hỏng trong quá trình vận chuyển, có lỗi nhà sản xuất, hoặc bất cứ trường hợp có lỗi khách quan nào xảy ra với toàn bộ chi phí do công ty chịu.',
}
...
export const fakeBlogTransportPolicy = {
  ...
  viewed: 10,
  image:
    'https://dongphucict.com/public/upload/images/thumb_baiviet/chinh-sach-giao-hang-751679825333.png',
  content: [
    {
      section: '',
      subsection: [
  ...
  type: 'cs',
  description:
    'Với mong muốn có thể phục vụ khách hàng tốt nhất, L’angfarm cung cấp dịch vụ giao hàng đến tận tay khách hàng trên toàn quốc thông qua việc chọn mua sản phẩm trên website thương mại điện tử này',
}
...
export const fakeBlogSecurityPolicy = {
      ...
      subsection: [
        {
          ...
          content:
            'Việc thu thập thông tin chủ yếu trên website bao gồm: Họ &l tên, email, số điện thoại, địa chỉ khách hàng. Đây là các thông tin cần thiết tối thiểu để khách hàng có thể sử dụng dịch vụ mua hàng online giao tận nơi của <b>Langfarm</b>',
          image: [],
        },
        {
        ...
        },
        {
          ...
          content:
            'Dữ liệu của khách hàng sẽ được lưu trữ cho đến khi có yêu cầu huỷ bỏ từ khách hàng. Còn lại trong mọi trường hợp, thông tin khách hàng sẽ được bảo mật trên máy chủ của <b>Langfarm</b> hoặc đối tác cung cấp dịch vụ máy chủ',
          image: [],
        },
        {
  ...
  type: 'cskh',
  description:
    'Việc thu thập thông tin chủ yếu trên website bao gồm: Họ & tên, email, số điện thoại, địa chỉ khách hàng. Đây là các thông tin cần thiết tối thiểu để khách hàng có thể sử dụng dịch vụ mua hàng online giao tận nơi của Langfarm.',
}
...
export const fakeBlogGuide = {
  ...
  viewed: 10,
  image:
    'https://langfarmstore.com/_next/image?url=https%3A%2F%2Flangfarm-backend.s3.amazonaws.com%2Fhuonddan.png&w=1080&q=75',
  content: [
    {
      section: '',
      subsection: [
        ...
        },
        {
          ...
          content:
            '&lQuý khách có thể tìm kiếm sản phẩm theo 1 trong 3 cách:Gõ tên sản phẩm vào thanh tìm kiếm.:Tìm theo danh mục.:Tìm theo các sản phẩm nổi bật hoặc bán chạy.',
          image: [],
        },
        {
          title: 'Bước 2: Thêm sản phẩm vào giỏ hàng',
          content:
            '&lKhi đã tìm được sản phẩm mong muốn, quý khách vui lòng bấm vào hình hoặc tên của sản phẩm để vào trang thông tin chi tiết của sản phẩm, sau đó:Kiểm tra thông tin sản phẩm, giá cả, thông tin khuyến mãi.:Chọn số lượng mong muốn.:Thêm sản phẩm vào giỏ hàng.',
          image: [],
        },
        {
      ...
      subsection: [
        {
          ...
          image: [
            'https://langfarm-staging-backend.s3.amazonaws.com/Screenshot%202024-02-23%20at%2011.58.16.png',
          ],
        },
      ],
    },
...
export const fakeBlog = {
  ...
  viewed: 10,
  image:
    'https://langfarmstore.com/_next/image?url=https%3A%2F%2Flangfarm-backend.s3.amazonaws.com%2Fcaoatiso.webp&w=1080&q=75',
  content: [
    {
      section: '',
      subsection: [
      ...
      subsection: [
        {
          ...
          image: [
            'https://file.hstatic.net/1000303672/file/1_2c69ec6d601a4ebd8f628fdb7f3e9c41_1024x1024.jpg',
          ],
        },
      ],
    },
    {
      ...
      subsection: [
        ...
        },
        {
          ...
          content:
            'Là loài thực vật có hàm lượng chất chống oxy hoá cao nhất trong tất cả các loại rau, Polyphenol, Quercetin và Vitamin C (chất chống oxy hoá có trong Atiso) có tính chất ngăn ngừa ung thư, hạn chế nguy cơ mắc bệnh viêm niêm mạc và xơ hoá, ung thư tuyền liệt tuyến va bệnh bạch cầu.',
          image: [],
        },
        {
          title: '2.2. Cải thiện tim mạch, giảm Cholesterol',
          content:
            'Lá Atisô có một số thành phần giúp giảm mức Cholesterol xấu (LDL) và tăng mức Cholesterol tốt (HDL hoặc Omega-3), cải thiện sức khoẻ tim mạch cho cơ thể. Bên canh đó, Kali có trong lá Atisô đóng vai trò như một loại thuốc làm giãn mạch, giúp ngừa các biến chứng liên quan đến huyết áp và giảm nguy cơ mắc bệnh nhồi máu cơ tim và bệnh mạnh vành',
          image: [],
        },
        {
          ...
          image: [
            'https://file.hstatic.net/1000303672/file/2_573a0a8ca93a499c9b21cda1b798c107_1024x1024.jpg',
          ],
        },
        {
          title: '2.4. Ngăn ngừa các bệnh về dạ dày',
          content:
            'Bên cạnh đó, Atisô là một trong những thực phẩm tốt nhất cung cấp các vitamin, chất xơ và khoáng chất. Chất xơ giúp ngăn ngừa nguy cơ các bệnh về dạ dày, ruột, giúp làm dịu túi mật và giải quyết vấn đề khi các cơ quan bị tắc nghẽn.',
          image: [],
        },
        {
          title: '2.5. Giảm nguy cơ mắc bệnh về xương',
          content:
            'Khoáng chất Magie, Photpho, Mangan không những là thành phần thiết yếu trong việc tăng cường sức khoẻ và mât độ xương, giảm nguy cơ mắc bệnh về xương mà còn đóng vai trò quan trọng trong quá trình tổng hợp Protein, trao đổi chất của cơ thể, tối ưu hoá lượng canxi trong cơ thể giúp xương chắc khoẻ. Đặc biệt là giúp cho phụ nữ nuôi dưỡng thai nhi khỏe mạnh và phát triển bình thường trong thai kỳ.',
          image: [],
        },
        {
          title: '2.6. Giảm đường trong máu',
          content:
            'Trong cao atisô có các thành phần dược tính giúp ngăn chặn quá trình hình thành glucose trong gan. Mặt khác, gan lại là cơ quan chính yếu trong việc tiết ra mật để tiêu thụ thực phẩm và chất béo có trong cơ thể, đồng thời giữ lượng đường dưới dạng glycogen rồi chuyển đổi lại thành glucose cung cấp cho máu.',
          image: [],
        },
        {
          title: '2.7. Cải thiện giấc ngủ',
          content:
            'Cao Atisô có chứa hàm lượng caffein vừa phải giúp tinh thần thoải mái, dễ chịu và thư giãn cơ thể, giảm thiểu khả năng hình thành bệnh lý liên quan đến stress và hạn chế ảnh hưởng của stress, từ đó giúp cơ thể đi vào giấc ngủ dễ hơn.',
          image: [
            'https://file.hstatic.net/1000303672/file/3_8cbb61a5cf3642759c840387fa276578_1024x1024.png',
          ],
        },
      ],
    },
      ...
      subsection: [
        {
          ...
          image: [
            'https://file.hstatic.net/1000303672/file/4_fac830b0bdb34353b4d91e7b5dccf702_1024x1024.jpg',
          ],
        },
      ],
    },
      ...
      subsection: [
        {
          ...
          image: [
            'https://file.hstatic.net/1000303672/file/5_962fa5805ec4495fa6d214d99c356a50_1024x1024.jpg',
          ],
        },
        {
          ...
          image: [
            'https://file.hstatic.net/1000303672/file/6_04ab64a0af964aeaaf9460afd8cf010b_1024x1024.jpg',
          ],
        },
      ],
    },
  ...
  type: 'tt',
  description:
    'Hiện nay, với những hoạt chất có công dụng cực tốt, atisô không chỉ để ăn, làm trà mà còn được trồng để làm cao thuốc. Để giữ nguyên chất dinh dưỡng và thành phần duợc tính có trong Atisô, với công nghệ tân tiến nhất, Langfarm đã cô đặc lá tươi và cho ra sản phẩm Cao Atisô.',
}
...
export const fakeBlogList = [
  fakeBlog,
  fakeBlogPaymentPolicy,
  fakeBlogReturnPolicy,
  fakeBlogSecurityPolicy,
  fakeBlogTermsOfUse,
  fakeBlogTransportPolicy,
  fakeBlogVAT,
  fakeBlogGuide,
]
