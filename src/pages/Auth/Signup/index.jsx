        ...
        <Col span={12} className="signup-wrapper">
          ...
          <div className="signup-data">
            <Form
              ...
              autoComplete="off"
            >
              <Form.Item name="name" className="default-input">
                <Input placeholder="Họ và tên" />
              </Form.Item>

              <Form.Item name="date-picker" className="default-input">
                <DatePicker
              ...
              <Form.Item name="province" className="default-select">
                <Select placeholder="Tỉnh/thành phố"></Select>
              </Form.Item>

              <Form.Item name="ward" className="default-select">
                <Select placeholder="Vui lòng chọn tỉnh/thành phố trước!"></Select>
              </Form.Item>

              <Form.Item name="street" className="default-input">
