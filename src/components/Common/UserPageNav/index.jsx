      ...
      <div className="navigation">
        <div className="navigation-wrapper">
          <div className="nav-info-wrapper">
            <div
              id={type === 'nav-info' ? '' : 'nav-info'}
              className="nav-target have-icon"
              onClick={() => {
            ...
            <div
              id="smooth-element-profile"
              className={`${haveDropDown === 'nav-info' ? 'dropdown-open' : ''}`}
            >
              <div
                onClick={() => {
                  return navigate('/user/profile')
          ...
          <div
            onClick={() => {
              return navigate('/user/purchase-history')
            }}
            id="nav-purchase"
            className="nav-target have-icon"
          >
          ...
          <div className="nav-notifications-wrapper">
            <div
              id={type === 'nav-notification-order' ? '' : 'nav-notification-order'}
              className="nav-target have-icon"
              onClick={() => {
            ...
            <div
              id="smooth-element-notification"
              className={`${haveDropDown === 'nav-notification' ? 'dropdown-open' : ''}`}
            >
              <div
                onClick={() => {
                  return navigate('/user/notifications/order')
                }}
                id="nav-notification-order"
                className="nav-target"
              >
                Cập nhật đơn hàng
              </div>
              ...
              <div
                ...
                id="nav-notification-new-update"
                className="nav-target"
              >
                Cập nhật Chang House
              </div>
            </div>
          </div>
          <div
